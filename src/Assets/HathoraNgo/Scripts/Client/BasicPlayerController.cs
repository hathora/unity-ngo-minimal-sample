...
/// <summary>
    ...
    public class BasicPlayerController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (verboseLogs)
                Debug.Log($"[BasicPlayerController.Start] RigidBody found on '{rb.gameObject.name}");
        }
        ...
        {
            if (verboseLogs)
                Debug.Log($"[BasicPlayerController.OnCollisionEnter]  Collision with {collision.gameObject.layer}");
